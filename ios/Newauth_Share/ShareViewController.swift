...
//  Newauth_Share
//
//  Created by Nida Khan on 14/03/24.
//
...
class ShareViewController: SLComposeServiceViewController {
 ...
 let hostAppBundleIdentifier = "io.newauth.mobile"
 let shareProtocol = "NewauthShareMedia" //share url protocol (must be unique to your app, suggest using your apple bundle id, ie: `hostAppBundleIdentifier`)
